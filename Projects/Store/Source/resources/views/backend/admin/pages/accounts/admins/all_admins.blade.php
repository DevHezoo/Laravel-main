...
@endif
<img src="{{ (!empty($user->photo)) ? asset('/frontend/upload/admin_images/'.$user->photo) : asset('/frontend/upload/no_image.jpg') }}" alt="Avatar" class="rounded-circle" />
</div>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/admin/view/admin/{{$user->id}}"
                                ><i class="bx bx-edit-alt"></i> Edit</a
                              >
                              <a class="dropdown-item" href="/admin/delete/admin/{{$user->id}}"
