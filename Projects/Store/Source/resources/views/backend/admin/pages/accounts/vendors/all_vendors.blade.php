...
@section('dashboard')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage /</span> vendor's</h4>


              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">All vendor's</h5>
...
@endif
<img src="{{ (!empty($user->photo)) ? asset('/frontend/upload/vendor_images/'.$user->photo) : asset('/frontend/upload/no_image.jpg') }}" alt="Avatar" class="rounded-circle" />
</div>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/admin/view/vendor/{{$user->id}}"
                                ><i class="bx bx-edit-alt"></i> Edit</a
                              >
                              <a class="dropdown-item" href="/admin/delete/vendor/{{$user->id}}"
