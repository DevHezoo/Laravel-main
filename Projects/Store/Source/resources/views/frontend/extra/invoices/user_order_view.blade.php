...
<!-- #Invoice By {{ $infos['seo']['seo_meta_title'] }} -->
<title>#Order By {{ $infos['user']['user_name'] }}</title>
 ...
 <!-- meta character set -->
  ...
  <link rel="stylesheet" href="{{ asset('frontend/extra/invoice/css/style.css') }}">
      ...
      <div class="tm_invoice tm_style1 tm_type1" id="tm_download_section">
        <div class="tm_invoice_in">
          ...
          <div class="tm_invoice_info tm_mb25">
            <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Invoice No<br></b>{{ $infos['order']['Invoice_ID'] }}</div>
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0">Payment: <b>{{ $infos['order']['Payment_Type'] }}</b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
            ...
            <div class="tm_invoice_right tm_text_right">
              ...
              <p>
                ...
                {{ $infos['order']['Payment_Type'] }} | {{ $infos['order']['Currency'] }}
        <br>
        {{ $infos['order']['phone'] }}<br>
              </p>
            </div>
          </div>
...
@foreach($items as $key => $item)
                    <tr>
                      <td class="tm_width_3">{{$key + 1}}. {{$item->product->product_slug}}</td>
            <td class="tm_width_1">{{$item->product->id}}</td>
                      
                      <td class="tm_width_4">{{$item->product->short_desc}}</td>
                      <td class="tm_width_2">${{$item->product->product_price}}</td>
...
@endforeach             
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                ...
                <p class="tm_m0">Security Token : {{ $infos['order']['Invoice_Code'] }}<br>Amount: ${{ $infos['order']['Paid_Price'] }}</p>
              </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">${{ $infos['order']['Paid_Price'] }}</td>
                    </tr>
                    <tr class="tm_gray_bg">
                    ...
                    <tr class="tm_accent_bg">
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">${{ $infos['order']['Paid_Price'] }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tm_invoice_footer tm_type1">
              ...
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center">
                  <img src="{{ asset('frontend/extra/invoice/img/sign.svg') }}" alt="Sign">
  ...
  <script src="{{ asset('frontend/extra/invoice/js/jquery.min.js') }}"></script>
  <script src="{{ asset('frontend/extra/invoice/js/jspdf.min.js') }}"></script>
  <script src="{{ asset('frontend/extra/invoice/js/html2canvas.min.js') }}"></script>
