...
<body>
 ...
 <!-- Start Header Area -->
    <header class="header_area sticky-header">
     ...
     @include('frontend.errors.header')
    ...
    <section class="tracking_box_area section_gap">
        <div class="container">
            <div class="tracking_box_inner">
                <p>This isn't a problem with your browser, your computer, or your internet connection. It's a problem with the site you're trying to visit.</p>
            </div>
        </div>
    </section>
