...
@endphp
                            <tr>
                                ...
                                <td>
                                    <div class="media">
           <div  class="header-cart-item-img remove-wishlist" data-product-id='{{$product->id}}' >
...
$('.header-cart-item-img.remove-wishlist').on('click', function() {
...
var productid = $(this).data('product-id');
        ...
        $.ajax({ 
            type: 'POST',
            url: '{{ route("wishlist.remove", ["ProductID" => ":productid"]) }}'.replace(':productid', productid),
            data: { 
                ProductID: productid,
                 _token: '{{ csrf_token() }}' },
