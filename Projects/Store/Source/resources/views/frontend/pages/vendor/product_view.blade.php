                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                             ...
                             <img width="617" height="313" class="img-fluid" src="{{ asset('frontend/' .$product->product_thumbnail) }}" alt="">
...
@if(count($imgs) > 0)
                             ...
                             <div  class="row">
                                ...
                                <div style="padding:5px" class="col-4">
                                    <img width="290" height="280" class="img-fluid" src="{{ asset('/frontend/' .$img->photo_url) }}" alt="">
                                </div>
                                @endforeach
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget author_widget">
                        	...
                        	<img height="120" width="120" class="author_img rounded-circle" src="{{ (!empty($user->photo)) ? '/frontend/upload/admin_images/'.$author->photo : '/frontend/upload/no_image.jpg' }}" alt="">
                            ...
                            <hr>
                            <a style="font-weight: bold; color:black;" href="/vendor/{{$user->id}}" class="white_bg_btn">View</a>
                        </aside>
