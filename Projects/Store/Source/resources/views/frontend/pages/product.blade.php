            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="/shop/?page=1">Shop<span class="lnr lnr-arrow-right"></span></a>
                        <a href="/shop/product/details/{{ $product->product_code }}">product-details</a>
                    </nav>
                </div>
            </div>
        </div>
...
@foreach ($photoUrls as $photoUrl)
    <div class="single-prd-item">
        <img class="img-fluid" src="{{ asset('frontend/'.$photoUrl) }}" alt="Product Image">
    </div>
@endforeach
...
@endphp
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                        <li><a class="active" href="/vendor/product/view/{{$product->id}}"><span>By</span> : {{ $user->username }}</a></li>

@if ($product->product_qty > 1)                            
<li><a class="active"><span>Availibility</span> :  Yes</a></li>
<!-- <li><span >Availibility</span><p class="active"> :  [{{$product->product_qty}}], Old Price (${{ $product->discount_price }})</p></li> -->

@else
<li><a href="#"><span>Availibility</span> : No </a></li>
@endif
                        </ul>
...
<!--                         <div class="product_count">
 ...
 -->
                        ...
                        <div class="card_area d-flex align-items-center">
                            ...
                            @auth
                            <a style="cursor: pointer;" data-product-id='{{$product->id}}'class="icon_btn add-wishlist-btn"><i class="lnr lnr lnr-heart"></i></a>
                            <a style="cursor: pointer;" data-product-id='{{$product->id}}'class="icon_btn add-compare-btn"><i class="lnr lnr lnr-eye"></i></a>
                            @endauth
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    {{ $product->long_descp }}
                    <p>Notes : {{ $product->product_qty }} Items Left.</p>
                </div>
...
@foreach($deal as $deal)
    <div class="col-lg-4 col-md-4 col-sm-6 mb-20">
        <div class="single-related-product d-flex">
            <a><img src="{{ asset( 'frontend/' .$deal->product_thumbnail) }}" alt="" width="70" height="70"></a>
            <div class="desc">
