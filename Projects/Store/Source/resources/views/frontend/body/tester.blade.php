...
<!-- {{ asset('frontend/main_assets/css/linearicons.css') }} -->
<head>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{ asset('frontend/extra/js/jquery.ajaxchimp.min.js') }}"></script>
	
	<script src="{{ asset('frontend/extra/js/jquery.nice-select.min.js') }}"></script>
	...
	<script src="{{ asset('frontend/extra/js/nouislider.min.js') }}"></script>
	
	<script src="{{ asset('frontend/extra/js/owl.carousel.min.js') }}"></script>
	<!--gmaps Js-->
