...
var iconCopiedInit = function iconCopiedInit() {
    var iconList = document.getElementById('dev-listener');
    var iconCopiedToast = document.getElementById('url-copied-toast');
    var iconCopiedToastInstance = new window.bootstrap.Toast(iconCopiedToast);
  
    var website = document.getElementById('web_uri').innerText;
    var dummyElement = document.createElement('textarea');
    dummyElement.style.display = 'none';
    dummyElement.value = website;

    if (iconList) {
        iconList.addEventListener('click', async function (e) {
            ...
            try {
                ...
                await navigator.clipboard.writeText(dummyElement.value);
                iconCopiedToast.querySelector('.toast-body').innerHTML = "<p class=\"fw-black\">Share Now!</p><span>Copied: </span><code style='color: rgba(76, 143, 233, 0.5)'>".concat(dummyElement.value, "</code>");
