                    ...
                    <div class="card-body">
                      <form>
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="meta_video" class="form-label">Video Url</label>
                            <input
                              class="form-control"
                              type="text"
                              id="meta_video"
                              name="meta_video"
                              value="{{$seo->meta_video}}"
                              autofocus
                            />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="meta_stripe_api" class="form-label">Stripe Api</label>
                            <input
                              class="form-control"
                              type="text"
                              id="meta_stripe_api"
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="meta_stripe_client" class="form-label">Stripe Client</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-3">
                            <label for="meta_li" class="form-label">Linkdin Link</label>
                            <input
                              class="form-control"
                              type="text"
                              id="meta_li"
                          ...
                          <div class="mb-3 col-md-3">
                            <label for="meta_in" class="form-label">Instgram Link</label>
                            <input
                              class="form-control"
                              type="text"
                              id="meta_in"
