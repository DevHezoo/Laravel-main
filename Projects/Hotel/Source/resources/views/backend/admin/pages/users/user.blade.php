...
@section('admin')
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Users /</span> Account</h4>
    ...
    <form method="post" action="{{ route('update.user.info',$user->id) }}"  enctype="multipart/form-data" >
      @csrf
...
<img
  src="{{ (!empty($user->photo)) ? asset('frontend/upload/user_images/'.$user->photo) : asset('frontend/upload/no_image.jpg') }}"
  alt="user-avatar"
...
<label for="imageUpload" tabindex="0">
  <span class="d-none d-sm-block">
    ...
    <form method="post" action="{{ route('update.user.pass',$user->id) }}" >
      @csrf
...
<!--                           <div class="mb-3 col-md-6">
                            <label for="current_password" class="form-label">Currently Password</label>
                            <input
                              class="form-control"
                              type="password"
                              id="current_password"
...
<script type="text/javascript">
  ...
  $('#imageUpload').change(function () {
    ...
    $('#reset').click(function() {
        ...
        $('#imagePreview').attr('src', "{{ (!empty($user->photo)) ? asset('frontend/upload/user_images/'.$user->photo) : asset('frontend/upload/no_image.jpg') }}");
    });
