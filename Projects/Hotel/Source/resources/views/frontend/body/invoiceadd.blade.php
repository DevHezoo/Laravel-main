          ...
          <div class="tm_table tm_style1">
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                <p class="tm_mb2"><b class="tm_primary_color">Payment info {order has been Added}:</b></p>
                <p class="tm_m0">Security Token : {{ $infos['order']['Invoice_Code'] }}<br>Amount: ${{ $infos['property']['property_price'] }}<br> Booked Has Been Added By Support</p>
              </div>
