...
<meta charset="utf-8" />
<title>#Invoice By {{ $order['title'] }}</title>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
            <div class="tm_invoice_left">
              <div class="tm_logo"><h2>{{ $order['title'] }}</h2></div>
            </div>
            <div class="tm_invoice_right tm_text_right tm_mobile_hide">
              <div class="tm_f50 tm_text_uppercase tm_white_color">Invoice #{{ $order['order'] }}</div>
            </div>
            <div class="tm_shape_bg tm_accent_bg tm_mobile_hide"></div>
          </div>
          <div class="tm_invoice_info tm_mb25">
            <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Invoice No<br></b>{{ $order['invoice_no'] }}</div>
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0">Payment: <b>{{ $order['payment_type'] }}</b></p>
              <p class="tm_invoice_date tm_m0">Date: <b>{{ $order['created'] }}</b></p>
            </div>
          ...
          <div class="tm_table tm_style1">
              ...
              <div class="tm_table_responsive">
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="tm_width_3">1. {{ $order['property_name'] }}</td>
					  <td class="tm_width_1">{{ $order['property_id'] }}</td>
                      
                      <td class="tm_width_4">{{ $order['description'] }}</td>
                      <td class="tm_width_2">${{ $order['price'] }}</td>
                      <td class="tm_width_1">1</td>
                      <td class="tm_width_2 tm_text_right">${{ $order['price'] }}</td>
                    </tr>
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                ...
                <p class="tm_m0">Security Token : {{ $order['payment_Token_Code'] }} <br>Amount: ${{ $order['price'] }}</p>
              </div>
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_gray_bg ">
                      ...
                      <td class="tm_width_3 tm_primary_color tm_bold tm_text_right">${{ $order['price'] }}</td>
                    </tr>
                    <tr class="tm_gray_bg">
                    ...
                    <tr class="tm_accent_bg">
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">${{ $order['price'] }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tm_invoice_footer tm_type1">
              ...
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center">
                  ...
                  <p class="tm_m0 tm_ternary_color">{{ $order['author'] }}</p>
          ...
          <div class="tm_note tm_text_center tm_font_style_normal">
            ...
            <p class="tm_m0">Copyright © 2023 <a href="{{ url($order['link']) }}" target="_blank">{{ $order['title'] }}</a>. All rights reserved.</p>
