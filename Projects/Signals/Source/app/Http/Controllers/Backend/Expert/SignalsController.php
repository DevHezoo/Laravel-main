...
class SignalsController extends Controller
{
    ...
    return view('backend.expert.pages.signals.guests.all_guests',compact('admin','seo','signals'));
    } // End Mehtod 
    ...
    return view('backend.expert.pages.signals.guests.add_guest', compact('admin'));
    }
    ...
    public function AddGuestSignal(Request $request)
{
    ...
    return redirect('expert/view/signals_guest')->with($notification);
}
    ...
    return view('backend.expert.pages.signals.guests.view_guest', compact('admin','signal','comments'));
    }
...
public function ViewAllPremiumsSignals(){
    ...
    return view('backend.expert.pages.signals.premiums.all_premiums',compact('admin','seo','signals'));
    } // End Mehtod 
    ...
    return view('backend.expert.pages.signals.premiums.add_premium', compact('admin'));
    }
    ...
    public function AddPremiumSignal(Request $request)
{
    ...
    return redirect('expert/view/signals_premium')->with($notification);
}
    ...
    return view('backend.expert.pages.signals.premiums.view_premium', compact('admin','signal','comments'));
    }
...
public function ViewAllUsersSignals(){
    ...
    return view('backend.expert.pages.signals.users.all_users',compact('admin','seo','signals'));
    } // End Mehtod 
    ...
    return view('backend.expert.pages.signals.users.add_user', compact('admin'));
    }
    ...
    public function AddUserSignal(Request $request)
{
    ...
    return redirect('expert/view/signals_user')->with($notification);
}
    ...
    return view('backend.expert.pages.signals.users.view_user', compact('admin','signal','comments'));
    }
