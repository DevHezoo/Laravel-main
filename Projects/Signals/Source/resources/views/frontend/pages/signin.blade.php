            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">{{ $translations['Log_In'] }}</h1>
                </div>
              </div>
            </div>
          </div>
...
<div class="col-md-6 form-group">
    <div style="display: inline-flex; align-items: center;">
        <input type="submit" class="btn btn-primary" value="{{ $translations['Log_In'] }}">
        <p style="margin: 0 10px;">{{ $translations['Or'] }}</p>
        

<button style="background-color: transparent; border: none;">
    <a href="/register" style="display: inline; text-decoration: none; color: inherit; white-space: nowrap;">
        {{ $translations['Sign_Up'] }}
              ...
              <div class="col-md-6 mb-5 mb-md-0"  data-aos="fade-up">
                ...
                <ul class="list-unstyled">
                  <li class="mb-3">
                    <strong class="d-block mb-1">{{ $translations['Log_In'] }}</strong>
                    <span>{{ $translations['Login_To_Start'] }}</span>
                  </li>
                </ul>
