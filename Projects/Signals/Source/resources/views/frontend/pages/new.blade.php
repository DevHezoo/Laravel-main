            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">{{ $translations['Article'] }}</h1>
...
@if($Article_Imgs && $Article_Imgs->count() > 0)
    <div class="row">
        @foreach($Article_Imgs as $img)
            <div class="col-md-{{ 12 / $Article_Imgs->count() }}">
                <figure>
                    <img src="{{ asset($img->img) }}" alt="{{ $New->article_title }}" class="img-fluid">
                </figure>
            </div>
        @endforeach
    </div>
@endif
            ...
            <blockquote><p>{{ $New->article_short_desc }}.</p></blockquote>

            <p>{{ $New->article_long_desc }}.</p>
...
@endforeach
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form method="post" action="{{ route('comment.blog', ['ID' => $New->id]) }}" class="">
                @csrf
