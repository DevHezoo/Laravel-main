            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  ...
                  <p class="mb-5" data-aos="fade-up"data-aos-delay="100">Error 503 : Unavailable error is a server-side error, the problem is usually with the website's server.</p>  
                </div>
              </div>
            </div>
          </div>
