            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  ...
                  <p class="mb-5" data-aos="fade-up"data-aos-delay="100">Error 405 : Method Not Allowed error indicates that the server received a web browser request but rejected the HTTP method.</p>  
                </div>
              </div>
            </div>
          </div>
