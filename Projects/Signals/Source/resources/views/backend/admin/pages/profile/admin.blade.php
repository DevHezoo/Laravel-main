...
@section('dashboard')
    ...
    <form method="post" action="{{ route('update.my.info') }}"  enctype="multipart/form-data" >
      @csrf
...
<img
  src="{{ (!empty($admin->photo)) ? asset($admin->photo) : asset('frontend/upload/no_image.jpg') }}"
  alt="user-avatar"
...
<label for="imageUpload" tabindex="0">
  <span class="d-none d-sm-block">
    ...
    <form method="post" action="{{ route('update.my.pass',$admin->id) }}" >
      @csrf
...
<script type="text/javascript">
  ...
  $('#imageUpload').change(function () {
    ...
    $('#reset').click(function() {
        ...
        $('#imagePreview').attr('src', "{{ (!empty($admin->photo)) ? asset($admin->photo) : asset('frontend/upload/no_image.jpg') }}");
    });
