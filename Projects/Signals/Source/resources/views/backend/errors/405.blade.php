 ...
 <!-- Error -->
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">Error : 405</h2>
        <p class="mb-4 mx-2">Oops! 😖 Method Not Allowed error indicates that the server received a web browser request but rejected the HTTP method.</p>
