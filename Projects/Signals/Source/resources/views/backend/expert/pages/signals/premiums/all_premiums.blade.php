        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/expert/view/signal_premium/{{$signal->id}}">
                        <i class="bx bx-edit-alt"></i> Edit
                    </a>
                    <a class="dropdown-item" href="/expert/delete/signal_premium/{{$signal->id}}">
...
@endforeach
    ...
    <div class="buy-now">
      <a
        href="/expert/new/signal_premium"
