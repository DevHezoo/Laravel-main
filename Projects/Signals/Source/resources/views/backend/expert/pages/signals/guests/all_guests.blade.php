        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/expert/view/signal_guest/{{$signal->id}}">
                        <i class="bx bx-edit-alt"></i> Edit
                    </a>
                    <a class="dropdown-item" href="/expert/delete/signal_guest/{{$signal->id}}">
...
@endforeach
    ...
    <div class="buy-now">
      <a
        href="/expert/new/signal_guest"
        class="btn btn-danger btn-buy-now"
        >Add New Guest Signal</a
      >
    </div>
