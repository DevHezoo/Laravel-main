        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/expert/view/signal_user/{{$signal->id}}">
                        <i class="bx bx-edit-alt"></i> Edit
                    </a>
                    <a class="dropdown-item" href="/expert/delete/signal_user/{{$signal->id}}">
...
@endforeach
    ...
    <div class="buy-now">
      <a
        href="/admin/new/signal_user"
        class="btn btn-danger btn-buy-now"
        >Add New User Signal</a
      >
    </div>
