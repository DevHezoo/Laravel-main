...
@section('dashboard')
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Users /</span> Signals</h4>
    ...
    <form method="post" action="{{ route('expert.create.new.user.signal') }}"  enctype="multipart/form-data" >
      @csrf
...
document.getElementById('deactivateButton').addEventListener('click', function() {
        ...
        window.location.href = '/expert/view/signals_user';
