@extends('backend.expert.main.main')
@section('dashboard')
                       <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Premium /</span> Signals</h4>
    ...
    <form method="post" action="{{ route('expert.edit.premium.signal',$signal->id) }}"  enctype="multipart/form-data" >
      @csrf
  ...
  $(document).ready(function() {
    ...
    document.querySelectorAll('.delete-comment-btn').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            document.getElementById('deleteCommentForm').action = '/expert/delete/signal/comment/' + commentId;
...
document.getElementById('deactivateButton').addEventListener('click', function() {
    if (confirm("Are you sure you want to delete this Signal?\nOnce you delete it, there is no going back. Please be certain.")) {
        ...
        window.location.href = '/expert/delete/signal_premium/{{$signal->id}}';
    } else {
