...
@section('dashboard')
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Guest /</span> Signals</h4>
    ...
    <form method="post" action="{{ route('expert.edit.guest.signal',$signal->id) }}"  enctype="multipart/form-data" >
      @csrf
...
document.getElementById('deactivateButton').addEventListener('click', function() {
    if (confirm("Are you sure you want to delete this Signal?\nOnce you delete it, there is no going back. Please be certain.")) {
        ...
        window.location.href = '/expert/delete/signal_guest/{{$signal->id}}';
    } else {
