...
<form class="rating-slider">
      ...
      <fieldset class="rating">
        <legend>Accent Rate</legend>
        <input type="radio" id="no-rate" class="input-no-rate" name="rating" value="0" checked="" aria-label="No rating.">

        <input type="radio" id="acent_1" name="rating" value="1">
        <label for="acent_1">1 star</label>

        <input type="radio" id="acent_2" name="rating" value="2">
        <label for="acent_2">2 stars</label>

        <input type="radio" id="acent_3" name="rating" value="3">
        <label for="acent_3">3 stars</label>

        <input type="radio" id="acent_4" name="rating" value="4">
        <label for="acent_4">4 stars</label>

        <input type="radio" id="acent_5" name="rating" value="5">
        <label for="acent_5">5 stars</label>
