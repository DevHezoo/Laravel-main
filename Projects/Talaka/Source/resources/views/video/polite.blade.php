...
<form class="rating-slider">

      <fieldset class="rating">
        <legend>politely Rate</legend>
        <input type="radio" id="no-rate" class="input-no-rate" name="polite" value="0" checked="" aria-label="No rating.">

        <input type="radio" id="polite_1" name="polite" value="1">
        <label for="polite_1">1 star</label>

        <input type="radio" id="polite_2" name="polite" value="2">
        <label for="polite_2">2 stars</label>

        <input type="radio" id="polite_3" name="polite" value="3">
        <label for="polite_3">3 stars</label>

        <input type="radio" id="polite_4" name="polite" value="4">
        <label for="polite_4">4 stars</label>

        <input type="radio" id="polite_5" name="polite" value="5">
        <label for="polite_5">5 stars</label>
