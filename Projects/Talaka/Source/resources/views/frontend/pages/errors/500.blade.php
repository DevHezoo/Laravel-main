          ...
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5">
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                ...
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">This isn't a problem with your browser, your computer, or your internet connection. It's a problem with the site you're trying to visit. your request too fast, try again, later.</p>
                <hr />
