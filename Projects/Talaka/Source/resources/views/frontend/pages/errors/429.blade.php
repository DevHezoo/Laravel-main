          ...
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5">
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="fw-black lh-1 text-300 fs-error">429</div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">technically an error — it’s a response from a server, (API).</p>
                <hr />
